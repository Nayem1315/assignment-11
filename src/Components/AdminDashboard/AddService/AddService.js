...
const AddService = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch('https://whispering-lowlands-26145.herokuapp.com/addService', {
      method: 'POST',
      body: formData
    })
      ...
      .then(data => {
        ...
        swal("Good job!", "Style added!", "success")
      })
      .catch(error => {
        console.error(error)
      })
  ...
  return (
    <section className="container-fluid row">
      <Sidebar></Sidebar>
      <div className="col-md-9 p-4 pr-5" style={{ position: "absolute", right: 0, backgroundColor: "#99ccff" }}>
        <h5 className="text-brand">Add Hair Style</h5>
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            <label htmlFor="exampleInputPassword1">Style Name :</label>
