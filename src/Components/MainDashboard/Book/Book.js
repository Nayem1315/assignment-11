...
const Book = () => {
  ...
  useEffect(() => {
    fetch(`https://whispering-lowlands-26145.herokuapp.com/bookingService/${email}`)
      .then((res) => res.json())
  ...
  useEffect(() => {
    ...
    fetch("https://whispering-lowlands-26145.herokuapp.com/serviceById", {
      method: "POST",
      headers: {
  ...
  const handlePayBooking = () => {
    ...
    fetch("https://whispering-lowlands-26145.herokuapp.com/payBooking", {
      method: "POST",
      headers: {
        "content-type": "application/json",
      },
